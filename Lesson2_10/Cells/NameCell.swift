...
class NameCell: UICollectionViewCell, CellProtocol {
    ...
    lazy var nameLabel = LabelView(font: .systemFont(ofSize: 12, weight: .regular), frameSize: CGRect(x: 0, y: nameImage.frame.maxY + 5, width: frame.width, height: 20), aligment: .center)
